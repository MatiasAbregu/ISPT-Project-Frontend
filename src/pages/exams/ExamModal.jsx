...
import { ExamTribuanlModal } from './ExamTribunalModal'
            ...
            <div className="examFormContainer">
                {
                    !tribunalModal ?
                            ...
                            <form onSubmit={handleSubmit(onSubmit, (errors) => console.log(errors))}>
                                {
                                    step == 0 ?
                                        <>
                                            ...
                                            <button className='tribunal-btn' type='button' onClick={() => setTribunalModal(true)}>
                                                ...
                                                Seleccionar docentes del tribunal *
                                            </button>
                                    ...
                                    Seleccione el docente titular de la mesa *
                                        ...
                                        : step == 1 ?
                                            <>
                                                <InputControl type={"number"} icon={"counter_1"} key={5} data={"RecordBook"} register={register}
                                                    error={errors.RecordBook}>
                                                    Ingrese el número del libro
                                                </InputControl>
                                                <InputControl type={"number"} icon={"counter_1"} key={6} data={"PageNumber"} register={register}
                        ...
                        : <ExamTribuanlModal setModal={setTribunalModal} setData={setTribunal} />
                }
            </div>
