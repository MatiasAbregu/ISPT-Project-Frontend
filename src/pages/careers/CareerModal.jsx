...
import CareerYUP from '../../schemas/careers/CareerYUP'
        ...
        <article className="careerModal">
            ...
            <div className="careerFormContainer">
                <form className="careerForm" onSubmit={handleSubmit(onSubmit, (errors) => console.log(errors))}>
                    <InputControl label={"Carrera"} icon={"signature"} type={"textbox"} data={"Name"} register={register} error={errors.Name}>Nombre de la carrera</InputControl>
                    <InputControl label={"Título"} icon={"badge"} type={"textbox"} data={"Title"} register={register} error={errors.Title}>Título con el que se recibe</InputControl>
                    <button type="submit" className="add-button">
                        <span className="material-symbols-outlined">save</span> 
                        {typeModal === "add" ? "Crear carrera" : "Actualizar carrera"}
                    </button>
                </form>
            </div>
        </article>
