...
export const StudentModal = ({ setModal, typeModal, studentId = 0, getAllStudents }) => {
    ...
    const createOrUpdateStudent = async (data) => {
        ...
        try {
            const res = typeModal == 1 ? await StudentService.createStudent(finalData) : await StudentService.updateStudent(finalData);
                                        ...
                                        <>
                                            ...
                                            <>
                                                <InputControl type={"text"} icon={"person"} register={register} data={"practicePlace"}
                                                    key={16} error={errors.practicePlace} readonly={typeModal == 2 ? true : false}>
